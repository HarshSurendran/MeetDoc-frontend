...
const Verification = () => {
    ...
    const getRequests = async () => {
        try {
            ...
            const pendingData = res.data.filter((doc: FormData) => doc.isVerified === false);
            setpendingRequests(pendingData);
            const approvedData = res.data.filter((doc: FormData) => doc.isVerified === true);
                    ...
                    <table className="w-full text-center">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3  text-sm font-medium text-gray-500">Gender</th>
                                <th className="px-6 py-3  text-sm font-medium text-gray-500">Age</th>
