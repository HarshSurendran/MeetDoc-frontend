...
import { changeProfilePhoto, getPhotoUrl, sendFile, updateProfile } from '@/services/doctor/doctor';
...
const DoctorProfilePage = () => {
  ...
  const handleDone = async () => {  
    try {
      ...
      console.log("This is the url for the dp", URL.createObjectURL(file), file);
      ...
      <Card className="max-w-7xl mx-auto">
        <CardHeader className="space-y-1">
          <div className="flex justify-between items-center">
            <CardTitle className="text-2xl font-bold text-blue-800">Doctor Profile</CardTitle>
            <Button
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                ...
                <div className="flex items-center justify-center space-x-1 text-yellow-500">
                  {profile.rating ? '★'.repeat(Math.floor(profile?.rating)): '★'}
                  <span className="text-gray-600 ml-1">({profile.rating || 0})</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <Input
                  type="date"
                  value={profile.date_of_birth? profile.date_of_birth.toISOString().split('T')[0] : new Date().toISOString().split('T')[0]}
                  onChange={(e) => setProfile({ ...profile, date_of_birth: new Date(e.target.value) })}
                  disabled={!isEditing}
                  className="bg-white"
                />
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProfile({
                      ...profile,
                      address: { ...profile.address, locality: e.target.value }
                    })}
                    disabled={!isEditing}
                    className="bg-white"
                  />
